...
Fixture-driven tests for VAL-1 and ANOM-1 per VPA_RULE_REGISTRY.yaml.
"""
...
from vpa_core.rule_engine import detect_anom_1, detect_val_1, evaluate_rules
...
class TestEvaluateRules:
    ...
    def test_mutual_exclusion(self, cfg: VPAConfig) -> None:
